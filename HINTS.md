...
Главная идея Binary Search Tree BST: In-order обход даёт отсортированный порядок. Для проверки — передавай допустимые
границы. Для удаления с двумя детьми — замени на минимум из правого.
